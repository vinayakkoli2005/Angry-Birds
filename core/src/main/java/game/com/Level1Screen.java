    ...
    public Level1Screen(Main main) {
        ...
        lose.addListener(new ClickListener() {
            ...
            public void clicked(InputEvent event, float x, float y) {
                ...
                saved_game.remove("Level1Screen");
                main.setScreen(new Lose_Screen(main,level1));
...
//                }
    ...
    private void initGameObjects() {
        ...
        birds.add(new Red_Bird(world, 240, 1000, new Texture(Gdx.files.internal("images/Red_Bird.png")), 80, 80, 3, this)); // Position near slingshot
        birds.add(new Black_Bird(world, 320, 1000, new Texture(Gdx.files.internal("images/Black_Bird.png")), 80, 80, 5, this)); // Position near slingshot
        ...
        blocks.add(new Wood_Block(world, 3000, 1000, new Texture(Gdx.files.internal("images/vertical_wood_block.png")), 70, 400, 5, this));  // Left Wood Block

        blocks.add(new Rock_Block(world, 4500, 1000, new Texture(Gdx.files.internal("images/vertical_rock_block.png")), 70, 300, 7, this));  // Left Rock Block

        blocks.add(new Ice_Block(world, 3000, 1400, new Texture(Gdx.files.internal("images/horizontal_ice_block.png")), 700, 50, 3, this)); // Right Ice Block

        blocks.add(new Wood_Block(world, 4500, 1300, new Texture(Gdx.files.internal("images/horizontal_wood_block.png")), 700, 50, 5, this)); // Right Wood Block


        pigs.add(new PIG_1(world, 3000, 1450, new Texture(Gdx.files.internal("images/PIG_1.png")), 80, 80, 5, this)); // Pig 1
        pigs.add(new PIG_2(world, 4500, 1350, new Texture(Gdx.files.internal("images/PIG_2.png")), 80, 80, 7, this)); // Pig 2
...
//        debugRenderer.render(world, camera.combined);
    ...
    public void winGame() {
        ...
        Timer.schedule(new Timer.Task() {
            @Override
            public void run() {
                main.setScreen(new Level2Screen(main));  // Transition to Level 2 Screen after 5 seconds
            }
        }, 5);
    }
    ...
    public void loseGame() {
        ...
        lose.addListener(new ClickListener() {
            @Override
            public void clicked(InputEvent event, float x, float y) {
                main.setScreen(new Lose_Screen(main,level1));  // Transition to Lose Screen
            }
        });
    }
