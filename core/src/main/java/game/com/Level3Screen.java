...
public class Level3Screen  extends Level implements Screen {
    ...
    public Level3Screen(Main main) {
        ...
        lose.addListener(new ClickListener() {
            ...
            public void clicked(InputEvent event, float x, float y) {
                ...
                saved_game.remove("Level1Screen");
                main.setScreen(new Lose_Screen(main,level3));
        ...
        createRightWall();
        initGameObjects();
        world.setContactListener(new CollisionHandler(slingshot,main,this));
    ...
    private void initGameObjects() {
        ...
        birds.add(new Red_Bird(world,240, 1000, new Texture(Gdx.files.internal("images/Red_Bird.png")), 80, 80, 6,this)); // Position near slingshot
        birds.add(new Big_Red_Bird(world,280, 1000, new Texture(Gdx.files.internal("images/Big_Red_Bird.png")), 100, 100, 8,this)); // Position near slingshot
        birds.add(new Black_Bird(world,320, 1000, new Texture(Gdx.files.internal("images/Black_Bird.png")), 80, 80, 10,this)); // Position near slingshot

        blocks.add(new Wood_Block(world,4500, 1000, new Texture(Gdx.files.internal("images/vertical_wood_block.png")), 70, 400,5,this)); // Right Wood Block

        blocks.add(new Rock_Block(world,5500, 1000, new Texture(Gdx.files.internal("images/vertical_rock_block.png")), 70, 400,8,this));  // Left Rock Block
        blocks.add(new Rock_Block(world,3500, 1000, new Texture(Gdx.files.internal("images/vertical_rock_block.png")), 70, 400,8,this));  // Left Rock Block


        blocks.add(new Ice_Block(world,4500, 1400, new Texture(Gdx.files.internal("images/horizontal_ice_block.png")), 1000, 60,5,this)); // Right Ice Block


        blocks.add(new Ice_Block(world,3900, 1620, new Texture(Gdx.files.internal("images/vertical_ice_block.png")), 70, 400,5,this)); // Right Ice Block
        blocks.add(new Ice_Block(world,5100, 1620, new Texture(Gdx.files.internal("images/vertical_ice_block.png")), 70, 400,5,this)); // Right Ice Block


        pigs.add(new PIG_1(world, 4500, 1460, new Texture(Gdx.files.internal("images/PIG_1.png")), 80, 80, 6,this)); // Pig 1
        pigs.add(new PIG_1(world, 4000, 1000, new Texture(Gdx.files.internal("images/PIG_2.png")), 80, 80, 10,this)); // Pig 2
        pigs.add(new PIG_1(world, 5000, 1000, new Texture(Gdx.files.internal("images/PIG_3.png")), 80, 80, 12,this)); // Pig 2


        this.slingshot = new Sling_Shot(130, 180,slingshotTexture , 300, 300,world,this,main);
...
//        debugRenderer.render(world, camera.combined);
    ...
    public void winGame() {
        ...
        Timer.schedule(new Timer.Task() {
            @Override
            public void run() {
                main.setScreen(new Home_screen(main));
            }
        }, 2);
    }
    ...
    public void loseGame() {
        ...
        lose.addListener(new ClickListener() {
            @Override
            public void clicked(InputEvent event, float x, float y) {
                main.setScreen(new Lose_Screen(main,level3));  // Transition to Lose Screen
            }
        });
    }
